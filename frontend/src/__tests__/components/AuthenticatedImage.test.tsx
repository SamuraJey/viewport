...
describe('AuthenticatedImage', () => {
  ...
  it('should handle empty src', () => {
    render(<AuthenticatedImage src="" alt="Test image" className="test-class" />);
  ...
  it('should set loading attribute correctly', async () => {
    ...
    render(<AuthenticatedImage src="/test-image.jpg" alt="Test image" loading="eager" />);
  ...
  it('should use lazy loading by default', async () => {
    ...
    render(<AuthenticatedImage src="/test-image.jpg" alt="Test image" />);
  ...
  it('should cleanup blob URL on unmount', async () => {
    ...
    const { unmount } = render(<AuthenticatedImage src="/test-image.jpg" alt="Test image" />);
