    ...
    <div className="relative min-h-screen overflow-hidden bg-surface text-text dark:bg-surface-dark dark:text-accent-foreground">
      ...
      <header className="sticky top-0 z-50 border-b border-border/40 bg-surface/90 backdrop-blur-xl dark:border-border/30 dark:bg-surface-dark/85">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
          <Link
            to="/"
            className="flex items-center gap-2.5 font-sans text-xl font-bold uppercase tracking-wider text-text transition-opacity hover:opacity-80 dark:text-accent-foreground"
          >
      ...
      <main id="main-content" tabIndex={-1} className="relative z-10">
        <section className="mx-auto grid w-full max-w-7xl gap-12 px-4 pb-16 pt-14 sm:px-6 lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:pb-24 lg:pt-24">
          ...
          >
            ...
            <div className="space-y-5">
              <h1 className="max-w-4xl font-sans text-5xl font-bold uppercase leading-[0.92] tracking-wider sm:text-6xl lg:text-7xl">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {trustStats.map((stat) => (
                ...
                >
                  <p className="font-sans text-3xl font-bold uppercase text-text dark:text-accent-foreground">
                    {stat.value}
                  </p>
        ...
        >
          <div className="mb-9 max-w-3xl">
            ...
            <h2 className="mt-3 font-sans text-4xl font-bold uppercase tracking-wide sm:text-5xl">
        ...
        >
          <div className="grid gap-6 rounded-4xl border border-border/50 bg-surface/85 p-6 shadow-xs backdrop-blur dark:border-border/35 dark:bg-surface-foreground/6 lg:grid-cols-[0.85fr_1.15fr] lg:p-8">
            <div className="space-y-4">
              ...
              <h2 className="font-sans text-4xl font-bold uppercase tracking-wider sm:text-5xl">
              ...
              {workflowSteps.map(({ icon: Icon, title, description }, index) => (
                ...
                >
                  <div className="mb-5 flex items-center justify-between gap-3">
                    ...
                    <span className="font-sans text-3xl font-bold text-accent/35">
                      0{index + 1}
                    </span>
                  </div>
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {planCards.map((card) => (
              ...
              >
                ...
                <h3 className="mt-4 font-sans text-4xl font-bold uppercase tracking-wide text-text dark:text-accent-foreground">
                  {card.name}
                </h3>
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <h2
                  ...
                  className="mt-5 max-w-3xl font-sans text-4xl font-bold uppercase tracking-wide text-text dark:text-accent-foreground sm:text-5xl"
                >
