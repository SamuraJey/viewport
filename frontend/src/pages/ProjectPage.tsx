          ...
          <div className="min-w-0 max-w-5xl space-y-2">
            ...
            <div>
              ...
              <h1
                ...
                className="max-w-full whitespace-normal wrap-break-word font-display font-bold uppercase leading-none tracking-wide text-text dark:text-accent-foreground"
              >
                {project.name}
              </h1>
