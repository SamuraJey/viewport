      ...
      <header className="relative overflow-hidden rounded-4xl border border-border/60 bg-surface p-5 shadow-sm dark:border-border/45 dark:bg-surface-dark">
        ...
        <div className="relative grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(23rem,34rem)] xl:items-center">
          <div className="max-w-2xl">
            ...
            <h1 className="font-sans text-4xl font-bold uppercase tracking-wider text-text dark:text-accent-foreground sm:text-5xl">
              Projects
            </h1>
                        ...
                        >
                          <div className="group/title relative flex flex-1 items-center text-left">
                            <div className="min-w-0 flex-1">
                              <h2
                                className={`wrap-anywhere overflow-hidden whitespace-normal font-sans ${titleTextSizeClass} font-bold uppercase text-text transition-colors [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:4]`}
                              >
                                {project.name}
                              </h2>
                            </div>
