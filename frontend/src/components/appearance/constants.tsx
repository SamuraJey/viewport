...
import type { CoverDisplayOption, PhotoSpacing, PublicColorScheme } from '../../types/gallery';
...
export interface AppearanceEditorProps {
  ...
  onSaveAppearance: (payload: Partial<AppearanceDraft>) => Promise<AppearanceDraft>;
  previewTitle: string;
  previewDate?: string;
  previewPhotographer?: string;
  infoTooltip: string;
}
