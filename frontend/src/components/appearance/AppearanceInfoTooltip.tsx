...
export const AppearanceInfoTooltip = ({ text }: AppearanceInfoTooltipProps) => (
  <AppPopover
    ...
    buttonClassName="inline-flex h-7 w-7 cursor-pointer items-center justify-center rounded-full text-muted transition-colors hover:bg-surface-1 hover:text-text focus:outline-hidden focus-visible:ring-2 focus-visible:ring-accent dark:hover:bg-surface-dark-1"
    buttonContent={<HelpCircle className="h-4 w-4" strokeWidth={2.25} />}
    anchor="top"
