      ...
      {options.map((option, index) => {
        ...
        return (
          <button
            ...
            className={`relative flex cursor-pointer items-center gap-2 transition-all duration-200 hover:bg-surface-2/50 focus:outline-hidden focus-visible:ring-[3px] focus-visible:ring-accent ${buttonClass} ${index > 0 ? 'border-l border-border/50' : ''}`}
