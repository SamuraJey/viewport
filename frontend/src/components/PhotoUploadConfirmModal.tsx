...
const PhotoItem = memo(({ file, preview, isUploading, onRemove, formatFileSize }: PhotoItemProps) => {
    ...
    return (
        ...
        >
            ...
            <div className="bg-black/70 text-white p-3 min-h-[60px] flex flex-col justify-center">
                <p className="text-sm font-semibold truncate break-words line-clamp-2">
                    {file.name}
                </p>
...
export const PhotoUploadConfirmModal = ({
    ...
    return (
        <div
            className={`fixed inset-0 z-50 flex items-start justify-center overflow-y-auto transition-all duration-200 pt-4 sm:pt-8 ${isOpen ? 'bg-black/50 backdrop-blur-sm' : 'bg-transparent backdrop-blur-0 pointer-events-none'
                }`}
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <ul className="text-xs sm:text-sm text-yellow-700 dark:text-yellow-300 space-y-1">
                                                {hasLargeFiles && (
                                                    <li>• Files larger than 15MB will be rejected</li>
                                                )}
                                                {hasInvalidTypes && (
                    ...
                    {result && (
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                >
                                    <p
                                        className={`text-2xl font-bold ${result.failed_uploads > 0
                                    ...
                                    <p
                                        className={`text-xs mt-1 ${result.failed_uploads > 0
