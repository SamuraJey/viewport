...
- Closing a populated or active queue shows a warning. Confirming cancellation
  ...
  Files already completed before cancellation are not rolled back; demo mode
  recalculates and persists their storage usage before propagating cancellation.
